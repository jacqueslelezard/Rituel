...
export default {
  ...
  'service:platform': {
    ...
    intro: 'Mallory Agoumba, Mike Destivelle, Elie Mietkiewicz, Timothy Sharpe et Nicolas Strale présentent',
    instructions: 'Commencer le rituel',
  },

  // content of the `sync` service
  'service:sync': {
    wait: `Invocation des esprits`,
  },
